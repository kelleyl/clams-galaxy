...
class EAST_td(ClamApp):
    ...
    def appmetadata(self):
        metadata = {"name": "EAST Text Detection",
                    ...
                    "vendor": "Team CLAMS",
                    "requires": [MediaTypes.V, MediaTypes.I],
    ...
    def annotate(self, mmif_json):
        ...
        if (video_filename):
            ...
            east_output = self.run_EAST_Image(image_filename) #east_output is a list of 0, [(x1, y1, x2, y2)] pairs
    ...
    def run_EAST_Image(self, image):
        ...
        net = cv2.dnn.readNet(os.path.join("..","..","..","..","..","tool-data","video_tools","frozen_east_text_detection.pb"))  # load the model
    ...
    def decode_predictions(scores, geometry):
        ...
        # confidence scores
        box_min_conf = .7  # minimum acceptable confidence
    ...
    def run_EAST(self, video_filename, mmif): # mmif here will be used for filtering out frames/
        ...
        def process_image(f):
            proc = cv2.medianBlur(f, 3) # reduce noise
            return proc
